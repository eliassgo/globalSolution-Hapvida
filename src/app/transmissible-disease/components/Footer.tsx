import {footerLinks, socialMedia} from "@/app/transmissible-disease/components/constants";
  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        <img src="https://cdn.discordapp.com/attachments/778783378593677333/1176985291064615106/Camada_1.png" alt="hapvida" className="w-[266px] h-[72px] object-contain" />
