import facebook from "~/images/transmissible-disease/facebook.svg";
import hapvida from "~/images/transmissible-disease/hapvida.png";
import instagram from "~/images/transmissible-disease/instagram.svg";
import linkedin from "~/images/transmissible-disease/linkedin.svg";
...
import send from "~/images/transmissible-disease/send.svg";
import shield from "~/images/transmissible-disease/shield.svg";
import star from "~/images/transmissible-disease/star.svg";
import twitter from "~/images/transmissible-disease/twitter.svg";
...
export const stats = [
  {
    ...
    subCategory: [
      ...
      },
      {
        ...
        description: "Informações sobre os cronogramas recomendados de vacinação para diferentes faixas etárias, destacando a importância de doses específicas em momentos-chave da vida para garantir imunidade adequada.",
        href: "https://www.who.int/teams/immunization-vaccines-and-biologicals/immunization-analysis-and-insights/global-monitoring/data-statistics-and-graphics",
      },
      {
        title: "Doenças Preveníveis por Vacinação",
        description: "Informações listadas e detalhadas algumas das principais doenças transmissíveis preveníveis por vacinação. Fornece informações sobre como as vacinas contribuíram para a redução significativa de casos dessas doenças.",
        href: "https://www.who.int/teams/immunization-vaccines-and-biologicals/immunization-analysis-and-insights/global-monitoring/data-statistics-and-graphics",
      },
      {
        title: "Mitigação de Surto",
        description: "Como campanhas de vacinação em massa têm sido eficazes na contenção de surtos e epidemias, demonstrando casos históricos em que a vacinação teve impacto significativo na mitigação de doenças infecciosas.",
        href: "https://www.who.int/teams/immunization-vaccines-and-biologicals/immunization-analysis-and-insights/global-monitoring/data-statistics-and-graphics",
      },
    ],
  },
  {
    ...
    subCategory: [
          ...
          },
          {
            ...
            description: "Importância da higiene respiratória, incluindo práticas como cobrir a boca ao tossir e espirrar, para evitar a propagação de gotículas contaminadas que podem transmitir infecções.",
          ...
          },
          {
            ...
            description: "Estratégias para prevenir infecções respiratórias em ambientes coletivos, como escolas e locais de trabalho, incluindo ventilação adequada, distanciamento social e uso de máscaras.",
            href: "https://www.who.int/publications/i/item/WHO-2019-nCoV-IPC-2021.1",
          },
          {
            title: "Conscientização e Educação Pública",
            description: "Importância da conscientização pública sobre práticas preventivas para infecções respiratórias agudas. Explora campanhas educativas para informar sobre sintomas, métodos de prevenção e busca por atendimento médico adequado.",
    ...
    subCategory: [
        {
          ...
          },
          {
            ...
            description: "Administração de medicamentos antimaláricos como uma medida preventiva, particularmente para pessoas que vivem ou viajam para áreas endêmicas.",
          ...
          },
          {
            ...
            description: "Iniciativas para controlar a população de mosquitos transmissores da malária, incluindo o uso de inseticidas, drenagem de áreas propícias à reprodução e o desenvolvimento de mosquitos geneticamente modificados.",
          ...
          },
          {
            ...
            description: "Destaca a importância de programas educativos para informar comunidades sobre os sintomas da malária, métodos de prevenção e a busca por tratamento adequado.",
